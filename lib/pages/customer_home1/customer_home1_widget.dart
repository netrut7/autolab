...
import 'customer_home1_model.dart';
export 'customer_home1_model.dart';

class CustomerHome1Widget extends StatefulWidget {
  const CustomerHome1Widget({super.key});

  static String routeName = 'customerHome1';
  static String routePath = '/customerHome1';

  @override
  State<CustomerHome1Widget> createState() => _CustomerHome1WidgetState();
}

class _CustomerHome1WidgetState extends State<CustomerHome1Widget> {
  late CustomerHome1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerHome1Model());
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  _model.roleId1 = await queryUsersRecordOnce(
                                  ...
                                  if (valueOrDefault(
                                      ...
                                      '2') {
                                    context
                                        .goNamed(CustomerHome1Widget.routeName);
