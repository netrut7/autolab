                ...
                child: StreamBuilder<List<CarServiceRecord>>(
                  stream: queryCarServiceRecord(
                    queryBuilder: (carServiceRecord) => carServiceRecord.where(
                      ...
                      isGreaterThanOrEqualTo:
                          functions.getStartDateForFilter(widget.today!),
                    ),
                  ),
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewCarServiceRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewCarServiceRecord =
                            listViewCarServiceRecordList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 4.0, 16.0, 8.0),
                          child: Container(
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 10.0, 0.0, 10.0),
                                        child: Text(
                                          listViewCarServiceRecord.vechileNo,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
              ...
              Padding(
                ...
                child: StreamBuilder<List<BikeServiceRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<BikeServiceRecord> listViewBikeServiceRecordList =
                        snapshot.data!;
                    ...
                    return ListView.builder(
                      ...
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewBikeServiceRecordList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewBikeServiceRecord =
                            listViewBikeServiceRecordList[listViewIndex];
                        return Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 4.0, 16.0, 8.0),
                          child: Container(
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 10.0, 0.0, 10.0),
                                        child: Text(
                                          listViewBikeServiceRecord.vechileNo,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(
