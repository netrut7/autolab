              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Enter your chasis no. here...',
                    hintStyle:
                      ...
                      onPressed: () async {
                        ...
                        _model.vechileSearch =
                          ...
                          queryBuilder: (vechileDetailsRecord) =>
                              vechileDetailsRecord.where(
                            'chasis_no',
                            isEqualTo: _model.shortBioTextController.text,
                          ),
                          singleRecord: true,
                        ...
                        if (_model.vechileSearch?.chasisNo ==
                          ...
                          if ((_model.shortBioTextController.text ==
                                  _model.userVechileMap?.chasisNo) &&
                              (_model.userVechileMap?.mobile ==
                                  currentPhoneNumber)) {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Exists'),
                                  content: Text('Vechile Already in Your List'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Matched'),
                                  content: Text('Adding to your list'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
                            ...
                            await VechileDetailsRecord.collection
                                ...
                                .set(createVechileDetailsRecordData(
                                  ...
                                  company: _model.vechileSearch?.company,
                                  model: _model.vechileSearch?.model,
                                  vechileNo: _model.vechileSearch?.vechileNo,
                                  makeYear: _model.vechileSearch?.makeYear,
                                  chasisNo: _model.vechileSearch?.chasisNo,
                                  fuelType: _model.vechileSearch?.fuelType,
                                  transmission:
                                      _model.vechileSearch?.transmission,
                                  carBike: _model.vechileSearch?.carBike,
                                ));
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text('Chasis Number Not Matched'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                                        Navigator.pop(alertDialogContext),
